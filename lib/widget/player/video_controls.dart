...
import '../../chewie/material/widgets/playback_speed_dialog.dart';
...
class _MaterialDesktopControlsState extends State<AppVideoControls> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    if (_latestValue.hasError) {
      ...
      return errorWidget ?? Stack(children: [
          ...
          child: Stack(
            children: [
              if (_displayBufferingIndicator)
                ...
                _buildHitArea(),
              if(widget.showTopBar || chewieController.isFullScreen)
              _buildTopBar(context),
              Column(
  ...
  Widget _buildTopBar(BuildContext context) {
    return AnimatedOpacity(
      ...
      child: SafeArea(top: true,child: Container(
        height: 48,
  ...
  AnimatedOpacity _buildBottomBar(
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(bottom: chewieController.isFullScreen ? 10.0 : 5),
        child: SafeArea(
